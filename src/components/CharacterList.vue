...
<template>
	<div class="max-w-full">
		...
		<section class="pt-8 px-4 items-center">
			<div class="container flex flex-wrap mx-auto">
				<div class="w-full p-2 rounded md:w-1/4" v-for="item  in filteredCharachters">
		...
		<div class="flex flex-col items-center pt-6">
			...
			<div class="inline-flex mt-2 xs:mt-0">
				...
				<button
					class="inline-flex items-center py-2 px-4 text-sm font-medium text-white bg-gray-500 rounded-r border-0 border-l border-gray-700 hover:bg-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
